...
colSignalPPZC1023 = Amp .* colSampledPPZC1023 .* colSampledCarrieri;
...
for lp=1:time
    ...
    temp = ([colSampledPPZC1023(1+Delay:fs) colSampledPPZC1023(1:Delay)].*Amp_R .* (colSampledCarrieri + 1i*colSampledCarrieri))' * tempSignalPPZC1023;
